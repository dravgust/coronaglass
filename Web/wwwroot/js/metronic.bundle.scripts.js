...
var KTApp = function() {
    ...
    var initTooltip = function (el) {
        ...
        var align = el.data('text-align') ? 'tooltip-text-align-' + el.data('text-align') : ''; // ADDED BY EVGENY 26/12/2020
        var customClass = el.data('custom-class') ? el.data('custom-class') : ''; // ADDED BY EVGENY 15/01/2020
        //console.log("customClass",customClass);
        //console.log("tooltip.el.width", el.width());
        el.tooltip({
            trigger: triggerValue,
            template: '<div class="tooltip ' + skin + ' ' + width + ' ' + align + ' ' + customClass + '" role="tooltip" >\
                <div class="arrow"></div>\
...
var KTLayout = function() {
	...
	var initAsideToggler = function() {
		...
		asideToggler.on('toggle', function(toggle) {
            ...
            /* Removed by Evgeny 02.12.2019 (TypeError: headerMenu.pauseDropdownHover is not a function)
