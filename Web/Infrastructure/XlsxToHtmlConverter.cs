...
namespace CoreLibrary.XLSX
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XlsxToHtmlConverter">Converter</see> class.
        /// </summary>
        protected XlsxToHtmlConverter()
        {
            throw new NotImplementedException();
        }
                                    ...
                                    try
                                    {
                                        ...
                                        if (cell.StyleIndex != null && styles.Stylesheet.CellFormats.ChildElements[(int)cell.StyleIndex.Value] is CellFormat cellFormat)
                                        {
                                            try
                                            {
                                                ...
                                                {
                                                    numberingFormat = styles.Stylesheet.NumberingFormats.ChildElements.First(x => ((NumberingFormat)x).NumberFormatId == cellFormat.NumberFormatId.Value) as NumberingFormat;
                                                }
